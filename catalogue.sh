...
cp /root/3.7.shell-script-roboshop-app/catalogue.service /etc/systemd/system/catalogue.service &>> $LOGFILE
...
cp /root/3.7.shell-script-roboshop-app/mongo.repo /etc/yum.repos.d/mongo.repo &>> $LOGFILE
